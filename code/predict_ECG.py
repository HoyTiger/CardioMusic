...
if __name__ == '__main__':
    ...
    model = DMLNet2(pretrain=False).to(device)
    model.load_state_dict(torch.load('freeze_model/model_final_simple_cnn.pth', map_location=device))
    ...
    with torch.no_grad():
        ...
        print(var_sim, var_ecg, var_music)
